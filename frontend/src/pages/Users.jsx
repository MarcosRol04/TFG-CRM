...
const Users = () => {
  ...
  // ✅ true si puede editar/crear/eliminar
          ...
          <Table>
            <TableHead>
              <TableRow sx={{ backgroundColor: 'primary.main' }}>
                ...
                {/* 👇 Columna acciones solo visible para admin y manager */}
                {puedeGestionar && (
            ...
            <TableBody>
              {filteredUsers.length === 0 ? (
                <TableRow>
                  <TableCell colSpan={puedeGestionar ? 5 : 4} align="center" sx={{ py: 5 }}>
                ...
                filteredUsers.map((user) => (
                  <TableRow key={user.id} hover>
                    ...
                    {/* 👇 Botones solo visibles para admin y manager */}
                    {puedeGestionar && (
